...
class NotificationService
{
    public function notifyTaskCreated(TaskCreated $e): void
    {
        $title = 'Nova tarefa';
        $body = $e->title;
        $this->store(null, $e->tenantId, 'task.created', $title, $body, ['task_id' => $e->taskId]);
    }
    ...
    public function notifyTaskAssigned(TaskAssigned $e): void
    {
        ...
        $this->store($e->assigneeId, $e->tenantId, 'task.assigned', $title, $body, ['task_id' => $e->taskId]);
    }
    ...
    public function notifyTaskCompleted(TaskCompleted $e): void
    {
        ...
        $this->store($e->assigneeId, $e->tenantId, 'task.completed', $title, $body, ['task_id' => $e->taskId]);
    }
    ...
    public function notifyStageChanged(CustomerStageChanged $e): void
    {
        ...
        $this->store($e->userId, $e->tenantId ?? 'default', 'customer.stage.changed', $title, $body, [
    ...
    private function store(?string $userId, string $tenantId, string $type, string $title, string $body, array $data = []): void
    {
        ...
        Log::info('notification_created', ['type' => $type, 'user_id' => $userId, 'tenant_id' => $tenantId]);
    }
}
